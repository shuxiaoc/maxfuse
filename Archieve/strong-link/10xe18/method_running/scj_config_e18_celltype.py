...
class Config(object):
    def __init__(self):
        ...
        if DB == '10x':
            ...
            self.input_size = 14291
            self.rna_paths = ['e18mouse/exprs_10xe18_rna.npz']
            self.rna_labels = ['e18mouse/cellType_10xe18.txt']
            self.atac_paths = ['e18mouse/exprs_10xe18_atac.npz']
