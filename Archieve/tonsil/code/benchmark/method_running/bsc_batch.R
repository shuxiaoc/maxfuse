#bindsc benchmark on 10k30k 5 batch cells, result used to produce matching accu and slt ari repeats
library(Seurat)
library(bindSC)
library(Matrix)
library(matrixStats)
...
for (i in c(1:5)){
  ...
  #x_input_features =  colnames(protein.shared.sub)
  #z0_input_features =  colnames(rna.shared.sub)
