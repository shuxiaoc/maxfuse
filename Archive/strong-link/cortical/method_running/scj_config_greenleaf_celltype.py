...
class Config(object):
    def __init__(self):
        ...
        if DB == '10x':
            ...
            self.rna_paths = ['greenleaf/exprs_10xgreenleaf_rna.npz']
            self.rna_labels = ['greenleaf/cellType_10xgreenleaf.txt']
            self.atac_paths = ['greenleaf/exprs_10xgreenleaf_atac.npz']
