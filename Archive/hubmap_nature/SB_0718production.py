# this code is for MaxFuse matching and integration (for small bowell cells)
...
rna = mmread("/home/bkzhu/MaxFuse/production/hubmap/match/data/SB_immune_rna1X.txt")
rna_stro  = mmread("/home/bkzhu/MaxFuse/production/hubmap/match/data/SB_stroma_rna1X.txt")
rna_epi  = mmread("/home/bkzhu/MaxFuse/production/hubmap/match/data/SB_epi_rna1X_v2.txt")

protein = pd.read_csv("/home/bkzhu/MaxFuse/hubmap_phase2/codex_cleaned/SB_immune.csv")
protein_stro = pd.read_csv("/home/bkzhu/MaxFuse/hubmap_phase2/codex_cleaned/SB_stromal.csv")
protein_stro['cluster.term'] = protein_stro['Cell Type']
protein_epi = pd.read_csv("/home/bkzhu/MaxFuse/hubmap_phase2/codex_cleaned/SB_epi_codex.csv")
...
labels_rna = pd.read_csv('/home/bkzhu/MaxFuse/production/hubmap/match/data/SB_immune_rna_meta1X.csv')
labels_rna_stro = pd.read_csv('/home/bkzhu/MaxFuse/production/hubmap/match/data/SB_stroma_rna_meta1X.csv')
labels_rna_epi = pd.read_csv('/home/bkzhu/MaxFuse/production/hubmap/match/data/SB_epi_rna_meta1X_v2.csv')
...
# extract shared protein, no need to normalize for this data
...
df.to_csv("/home/bkzhu/MaxFuse/hubmap_phase2/match/output/SB_0718/full21.csv") # this is dataframe telling for each codex cell, which snrnaseq cell is considered the best match
...
df = pd.DataFrame.from_dict(dd)
df.to_csv("/home/bkzhu/MaxFuse/hubmap_phase2/match/output/SB_0718/full21_unique_data1.csv")
...
ebddf.to_csv("/home/bkzhu/MaxFuse/hubmap_phase2/match/output/SB_0718/full21_unique_embedding.csv")
