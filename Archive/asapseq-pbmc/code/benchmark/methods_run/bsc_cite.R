...
# copy sp filtering
act.shared.sub = act.shared[,colSds(act.shared)>0.5 & colSds(protein.shared)>0.1]
protein.shared.sub = protein.shared[,colSds(act.shared)>0.5 & colSds(protein.shared)>0.1]
