...
# copy sp filtering
rna.shared.sub = rna.shared[,colSds(rna.shared)>0.2 & colSds(protein.shared)>0.1]
protein.shared.sub = protein.shared[,colSds(rna.shared)>0.2 & colSds(protein.shared)>0.1]
